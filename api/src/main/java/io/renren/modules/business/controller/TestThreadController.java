...
import io.renren.modules.business.service.TestService;
...
public class TestThreadController {
    ...
    @Autowired
    private TestService threadService;
...
//                StringUtils.writeList("-", lists.get(i).hashCode());
                // 执行业务逻辑方法serviceTest()
//                List<String> finalI = lists.get(i);
//                executor.execute(new Runnable() {
//                    @Override
//                    public void run() {
//                        businessDeviceService.updateData(finalI);
//                    }
//                });
//            }
