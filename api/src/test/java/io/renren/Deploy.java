...
public class Deploy {
    ...
    public void run() throws MsgException {
        ...
        String groupStr =
                "112AdSmvp8xBZX4SDjxuZ16nAG3smcucjZiaDkT7CsMLAaDYY7Pw\t7\n" +
                        "11jHXW2mnpz8bjL6GXuveCZTaL2rDzMDUqV6KKinJSRFPNkf1Wb\t7\n" +
                        "116ZasRkgBeuGST8wJDTF71SLm1BBrhZW1N17MoxM95jbjwbu5w\t7\n" +
                        "11Gd7pwRHYmnVsrULjUMXprXMiZB552kvDMpzstp3w9e5JD8xXE\t7\n" +
                        "112SxFjGPKZi4BVc91xYiV8cWukeSCVhJpMoYSFrAFxZkp7HDTHv\t7\n" +
                        "112AHXkBDNyT4ieAzbqo5cHdXdnywELFs56UJXAPe15hiDtQL63x\t7\n" +
                        "11fkNASxG3MpfGTjP6kwp5PJghNhf1uLETtgSZwnJdSmegm6CZs\t8\n" +
                        "116ewHt8TfeBABx2HE5vsUeEvRywDfNUtcecxv6bi2j5TwW8aa4\t8\n" +
                        "11Cw1EGJr13cfEQ7xMQu4usCC8CbQq911LyMxwNSWDMffKFrvfZ\t8\n" +
                        "11f3a14YCzwCbxRRRreUGwh3V6FBNGsQvAE2svFhX2KuN9AJ3DN\t8\n" +
                        "11NqCSedXGkzFZcwVkM6eZkNjdFHgLA2JHq9N52SjQT4fdCEtpy\t8\n" +
                        "112SVBu4jAPnvadZ5Rhbvh4FnVgaPvKvZcb5NPzGP5okc5psjgEB\t8\n" +
                        "11zd6C45gWXhETrGtHa8XsfjADyo87Dr9scnqwuwoArhLAttJtZ\t7\n" +
                        "112kZtiSm33xHHjdrTi6izTL8WjUfwY9GwMP4ypN8UUDAyzSMCYK\t7\n" +
                        "113zGmSwGUV4LfsEfySGJojnsTvtZSKCXynVtwPdUTbS3Yhu3s7\t7\n" +
                        "11f6Ld8S92wTBvVHKbWUpXvowD6TeteyJQLikQsk3b32RYo4H1g\t7\n" +
                        "112bMHCC7S5S628J4tGLGpanSqRUSbGBVGbhR8SCqYazrRxFtixa\t7\n" +
                        "112275Fc7UnaVaeiLdu5QT4v1o1UXkpnL7jejRiSkfrjjWD3ffzZ\t7\n" +
                        "112jvURP8bDo46GfZEAFB7M3Lq35wuXEHS27S8o7iUR5i3Pp7mGi\t7\n" +
                        "11838m32aqX4NpiCPPGLYJSnnPrbjPbKVkUM9vT5JD4VbJ49pRx\t7\n" +
                        "1125rYi54QPTH1BSDcBhtzg1uScc6NpfJ5a8NA2JHThKX7PfGyD9\t7\n" +
                        "11d1yeFTmzKRATayW2QbUH75iwqUz1D2EJxEP2SJ7soznrxLyJj\t7\n" +
                        "112ka3MBKwT5RbpaFS9hag1DVvmM6nFHaht3Biep2iVfGXVpHKzH\t7\n" +
                        "115PPRS83HD2ozqzCd9ta282wn2CR5bvyzgk5Y1fQgApxckLWD6\t7\n";

        String deviceTableStr = "192.168.11.92\t11doprVqqD6J3schwWkebq1itvEnaG56gUvbJqALYfLBRkbmBWb\n" +
                ...
                "192.168.11.102\t118iydLsMK81msVHuVcXEwKuX8NCQPBkcN2A7tNrCfgAdn5z46S\n" +
                ...
                "192.168.11.170\t11EbuZcnpHsdA5gUpqNx3ztDz2e3VoBcnZkffR9KSJ6zvdjAyic\n" +
                "192.168.11.175\t11qmyuKsZriEpNjf1BowauNfnXBh7XPxfvvnzV4H6ozHrA67YQM\n" +
                "192.168.11.179\t11QwKPKxRixZqYnY4mEh5u5DNhGcFr64CZZtVeDPXvfhrDRUp5N\n" +
                ...
                "192.168.11.210\t11dXpmAdFKHd7DF4tb91NbL5tZqhyhoCus3piGSgPBujGacukjr\n" +
                "192.168.11.212\t112VbHeHqB8PzLntu1te9bZ7JYAAjhWwTwm2eo5iNGMWVKesLnLo\n" +
                "192.168.11.218\t1129TVRpHRmFue7n71yVYpM11VgHGsrbpUokFouurXdgYbkbfbt2\n" +
                "192.168.11.223\t112F4mHJiFRZmpaSC6ZyADYiNLSHDU2mayJMGw7DpwB3UuHfFg6b\n" +
                "192.168.11.224\t11CQMTwcGjzK9xNaTr3TtNtEK5FY3YfKZMhEhy52RUTLtUHirxo\n" +
...
//        structureInfo(groupStr, deviceTableStr, "./data/Hexs_shcz.txt", 416, 55, "shcz", "001616geae", 1680);
        ...
        structureInfo(toTableMap(walletStr), groupStr, deviceTableStr, 502, 67, "sh-cz-4", "001616deae", 1681);
    ...
    public void structureInfo(Map<String, String> wallet, String groupStr, String deviceTableStr, int startIndex, int groupStartIndex,
        ...
        for (Location location : locations) {
            ...
            for (int i = 0; i < location.getGeoCoords().size(); i++) {
                ...
                //String.format(script, gateway.getGeoCoord().lat, gateway.getGeoCoord().lng, gateway.getMYDevice().getAddress(), wallet.get(gateway.getMYDevice().getOwner().replaceAll("\t", "")))
